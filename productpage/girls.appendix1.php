<?php 
    ...
    $orderclauses=[
        1=>"SELECT * FROM porducts WHERE category= '14' and instock!='$zero' $orderby price asc",
        2=>"SELECT * FROM porducts WHERE category= '14' and instock!='$zero' $orderby price desc",
        3=>"SELECT * FROM porducts WHERE category= '14' and instock!='$zero' $orderby id desc",
        4=>"SELECT * FROM porducts WHERE category= '14' and instock!='$zero' $orderby rating desc"
    ];
