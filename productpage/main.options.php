		...
		<div class="h1">
			<div class="h1box">
				<a href="../login/login.php">
					<img src="images/login.png" width="21" height="27">
				</a>
			</div>
			<div class="h1box">
				<a href="<?php include("../shoppingcartnav2.php"); ?>">
					<img src="images/shopping crat.png" width="21" height="27">
				</a>
				<?php 
			...
			<div class="h1box h1boxalt3"><img src="images/prof.png" width="21" height="21"></div>
			<div class="h1box h1boxalt4">
				<div class="usname"><?php if(!empty($_SESSION["username"])){echo $_SESSION["username"];}else{echo "welcom Unknown";}?></div>
				<div class="exit"><form method="post" action="" name="exitform"><input type="submit" name="exitb" value="EXIT" class="ext"></form></div>
			</div>
			<a href="../index.php"><div class="h1box h1boxalt1">
			<div class="main"><img src="images/jilubarg.png" width="150" height="70" alt="jilubarg"></div>
			</div></a>
			<a href="../index.php"><div class="h1box h1boxalt2">Home</div></a>
			<a href="footer.page.php?id=7"><div class="h1box h1boxalt2">About</div></a>
			<a href="footer.page.php?id=8"><div class="h1box h1boxalt2">Contact</div></a>
		</div>
</div>
<div class="wrappro">
<?php
