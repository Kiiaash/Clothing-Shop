<?php 
    if(isset($_POST["searchbtn"])){
        ...
        $deftext="SELECT * FROM `porducts` WHERE category='13' AND name LIKE '%$searchitem%' ";
        $mainsql=" ";
        $g=" ";
        $v="";
        if(isset($_POST["size"])){
        ...
        $queries=[
            1=>"SELECT * FROM `porducts` WHERE category='13' AND `size` = 's' AND name LIKE '%$searchitem%' ",
            2=>"SELECT * FROM `porducts` WHERE category='13' AND `size2` = 'm' AND name LIKE '%$searchitem%' ",
            3=>"SELECT * FROM `porducts` WHERE category='13' AND `size3` = 'l' AND name LIKE '%$searchitem%' ",
            4=>"SELECT * FROM `porducts` WHERE category='13' AND `size4` = 'xl' AND name LIKE '%$searchitem%' ",
            5=>"SELECT * FROM `porducts` WHERE category='13' AND `size5` = 'xxl' AND name LIKE '%$searchitem%' ",
            6=>"SELECT * FROM `porducts` WHERE category='13' AND name LIKE '%$searchitem%' "
        ];
       if($g==2){
        $mainsql=$queries[2];
       }
